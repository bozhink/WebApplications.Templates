<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="WebApplication.WebForms.Template.IndovidualAuth.Account.OpenAuthProviders" %>
