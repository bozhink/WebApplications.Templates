<%@ Page Title="Verify Phone Number" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="WebApplication.WebForms.Template.IndividualAuth.Account.VerifyPhoneNumber" %>
